...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    List<String> selectall(){
        ...
        // Select All Query
        String selectQuery = "SELECT * FROM " +TABLE_USER +" ORDER BY name ASC" ;
    ...
    List<String> searchall(String name){
        List<String> contactList = new ArrayList<String>();
        // Select All Query
        String selectQuery = "SELECT name FROM " +TABLE_USER+" WHERE name LIKE '"+name+"%'" ;
